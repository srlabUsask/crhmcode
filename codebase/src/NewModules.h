...
//added by Manishankar Mondal
class Classdisplay : public ClassModule
{
public:
	Classdisplay(string Name, string Version = "undefined", CRHM::LMODULE Lvl = CRHM::PROTO) : ClassModule(Name, Version, Lvl) {};
	...
	Classdisplay* klone(string name) const;
};



//added by Manishankar Mondal
class ClassSWE_peak : public ClassModule
{
public:
	ClassSWE_peak(string Name, string Version = "undefined", CRHM::LMODULE Lvl = CRHM::PROTO) : ClassModule(Name, Version, Lvl) {};
	...
	ClassSWE_peak* klone(string name) const;
};

class ClassAlbedo_Change : public ClassModule
{
public:
	ClassAlbedo_Change(string Name, string Version = "undefined", CRHM::LMODULE Lvl = CRHM::PROTO) : ClassModule(Name, Version, Lvl) {};
	...
	//declared parameters
	const float * Albedo_change;
	const float * Albedo_min;
	const float * Albedo_max;
	const float * Albedo_Julian;

	void decl(void);
	void run(void);

	ClassAlbedo_Change* klone(string name) const;
};
...
class Class_SmithCreekBasin_GroupTemplate_Modified_20Oct_GrpA : public ClassModule
{
public:
	Class_SmithCreekBasin_GroupTemplate_Modified_20Oct_GrpA(string Name, string Version = "undefined", CRHM::LMODULE Lvl = CRHM::PROTO) : ClassModule(Name, Version, Lvl) {};




	Classbasin * cb = new Classbasin("test");
	//Classglobal * cg = new Classglobal("test");
	Classobs * co = new Classobs("test");
	/*ClassGrow_Crop * cgc = new ClassGrow_Crop("test");
	ClassAnnan *ca = new ClassAnnan("test");
	Classwalmsley_wind *cw = new Classwalmsley_wind("test");
	ClassLongVt *cl = new ClassLongVt("test");
	ClassCRHMCanopyClearing * cc = new ClassCRHMCanopyClearing("test");
	Classnetall * cn = new Classnetall("test");
	Classpbsm * cp = new Classpbsm("test");
	Classalbedo * cal = new Classalbedo("test");
	Classebsm *ce = new Classebsm("test");
	Classevap_Resist * cev = new Classevap_Resist("test");
	ClassPrairieInfil * cpr = new ClassPrairieInfil("test");
	ClassSoil *cs = new ClassSoil("test");
	ClassVolumetric *cv = new ClassVolumetric("test");
	ClassNetroute_M_D *cnet = new ClassNetroute_M_D("test");
	*/
	void decl(void);
	void init(void);
	void run(void);
	...
	Class_SmithCreekBasin_GroupTemplate_Modified_20Oct_GrpA* klone(string name) const;
};


class ClassCalc_tmean : public ClassModule
{
public:
	ClassCalc_tmean(string Name, string Version = "undefined", CRHM::LMODULE Lvl = CRHM::PROTO) : ClassModule(Name, Version, Lvl) {};
	...
	ClassCalc_tmean* klone(string name) const;
};

class ClassConvert_Qnsn_QnD : public ClassModule
{
public:
	ClassConvert_Qnsn_QnD(string Name, string Version = "undefined", CRHM::LMODULE Lvl = CRHM::PROTO) : ClassModule(Name, Version, Lvl) {};
	...
	ClassConvert_Qnsn_QnD* klone(string name) const;
};

class Classea_RH : public ClassModule
{
public:
	Classea_RH(string Name, string Version = "undefined", CRHM::LMODULE Lvl = CRHM::PROTO) : ClassModule(Name, Version, Lvl) {};
	...
	Classea_RH* klone(string name) const;
};

class ClassHt_Change : public ClassModule
{
public:
	ClassHt_Change(string Name, string Version = "undefined", CRHM::LMODULE Lvl = CRHM::PROTO) : ClassModule(Name, Version, Lvl) {};
	...
	ClassHt_Change* klone(string name) const;
};

class ClassJulian_Test : public ClassModule
{
public:
	ClassJulian_Test(string Name, string Version = "undefined", CRHM::LMODULE Lvl = CRHM::PROTO) : ClassModule(Name, Version, Lvl) {};
	...
	ClassJulian_Test* klone(string name) const;
};

class ClassNo_Display_Macro : public ClassModule
{
public:
	ClassNo_Display_Macro(string Name, string Version = "undefined", CRHM::LMODULE Lvl = CRHM::PROTO) : ClassModule(Name, Version, Lvl) {};

	//declared variables
	float * No_Display;
	const float * Qdflat_err;
	...
	ClassNo_Display_Macro* klone(string name) const;
};

class ClassSicartLong : public ClassModule
{
public:
	ClassSicartLong(string Name, string Version = "undefined", CRHM::LMODULE Lvl = CRHM::PROTO) : ClassModule(Name, Version, Lvl) {};
	...
	ClassSicartLong* klone(string name) const;
};


class ClassSlope_Qsi2 : public ClassModule
{
public:
	ClassSlope_Qsi2(string Name, string Version = "undefined", CRHM::LMODULE Lvl = CRHM::PROTO) : ClassModule(Name, Version, Lvl) {};
	...
	ClassSlope_Qsi2* klone(string name) const;
};

class ClassCalc_t : public ClassModule
{
public:
	ClassCalc_t(string Name, string Version = "undefined", CRHM::LMODULE Lvl = CRHM::PROTO) : ClassModule(Name, Version, Lvl) {};
	...
	ClassCalc_t* klone(string name) const;
};

class ClassHt_Change_Julian : public ClassModule
{
public:
	ClassHt_Change_Julian(string Name, string Version = "undefined", CRHM::LMODULE Lvl = CRHM::PROTO) : ClassModule(Name, Version, Lvl) {};

	float * Ht;
	const float * Ht_change;
	const float * Ht_min;
	const float * Ht_max;
	...
	ClassHt_Change_Julian* klone(string name) const;
};

class ClassTest_NDEFN : public ClassModule
{
public:
	ClassTest_NDEFN(string Name, string Version = "undefined", CRHM::LMODULE Lvl = CRHM::PROTO) : ClassModule(Name, Version, Lvl) {};
	...
	ClassTest_NDEFN* klone(string name) const;
};
