...
public:
	...
	void put_CustomTime(BOOL newValue)
	{
		static BYTE parms[] = VTS_BOOL;
	...
	{
		LPDISPATCH result;
		InvokeHelper(0x198, DISPATCH_PROPERTYGET, VT_DISPATCH, (void*)&result, nullptr);
		return result;
	}

	// IClockSeries properties
public:
