...
public:
	...
	long ClickedBox(long X, long Y)
	{
		...
		InvokeHelper(0x195, DISPATCH_METHOD, VT_I4, (void*)&result, parms, X, Y);
		return result;
	}
	LPDISPATCH get_BoxesRect(long Index)
	{
		LPDISPATCH result;
		static BYTE parms[] = VTS_I4;
		InvokeHelper(0x194, DISPATCH_PROPERTYGET, VT_DISPATCH, (void*)&result, parms, Index);
		return result;
	}
	long get_BoxTransparency()
	{
		long result;
		InvokeHelper(0x196, DISPATCH_PROPERTYGET, VT_I4, (void*)&result, nullptr);
		return result;
	}
	void put_BoxTransparency(long newValue)
	{
		static BYTE parms[] = VTS_I4;
		InvokeHelper(0x196, DISPATCH_PROPERTYPUT, VT_EMPTY, nullptr, parms, newValue);
	}

	// IDarvasSeries properties
public:
