...
// CActivityGauge wrapper class

class CActivityGauge : public COleDispatchDriver
{
public:
	CActivityGauge() {} // Calls COleDispatchDriver default constructor
	CActivityGauge(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	CActivityGauge(const CActivityGauge& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
...
public:
	...
	{
		unsigned long result;
		InvokeHelper(0x1f7, DISPATCH_PROPERTYGET, VT_UI4, (void*)&result, nullptr);
		return result;
	}
	...
	{
		static BYTE parms[] = VTS_I4;
		InvokeHelper(0x1f9, DISPATCH_METHOD, VT_EMPTY, nullptr, parms, Index);
	}
	long get_Count()
	{
		long result;
		InvokeHelper(0x1fa, DISPATCH_PROPERTYGET, VT_I4, (void*)&result, nullptr);
		return result;
	}
	long AddActivity(double Value, LPCTSTR label, unsigned long Color)
	{
		long result;
		static BYTE parms[] = VTS_R8 VTS_BSTR VTS_UI4;
		InvokeHelper(0x1fb, DISPATCH_METHOD, VT_I4, (void*)&result, parms, Value, label, Color);
		return result;
	}
	LPDISPATCH get_ActivityValues(long Index)
	{
		LPDISPATCH result;
		static BYTE parms[] = VTS_I4;
		InvokeHelper(0x1f6, DISPATCH_PROPERTYGET, VT_DISPATCH, (void*)&result, parms, Index);
		return result;
	}
	void Clear()
	{
		InvokeHelper(0x1fc, DISPATCH_METHOD, VT_EMPTY, nullptr, nullptr);
	}

	// IActivityGauge properties
public:
