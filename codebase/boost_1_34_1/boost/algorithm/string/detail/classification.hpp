...
//  classification functors -----------------------------------------------//
            ...
            #if BOOST_WORKAROUND(__BORLANDC__, BOOST_TESTED_AT(0x590)) && (__BORLANDC__ >= 0x560) && !defined(_USE_OLD_RW_STL)
                template<>
                inline bool is_classifiedF::operator()( char const Ch ) const
                {
