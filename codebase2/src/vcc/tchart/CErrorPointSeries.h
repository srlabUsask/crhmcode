...
public:
	...
	long Add(double AX, double AY, double ALeft, double ARight, double ATop, double ABottom, LPCTSTR AXLabel, unsigned long Value)
	{
		...
		InvokeHelper(0x12d, DISPATCH_METHOD, VT_I4, (void*)&result, parms, AX, AY, ALeft, ARight, ATop, ABottom, AXLabel, Value);
		return result;
	}
