...
// CActivityDonut wrapper class

class CActivityDonut : public COleDispatchDriver
{
public:
	CActivityDonut() {} // Calls COleDispatchDriver default constructor
	CActivityDonut(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	CActivityDonut(const CActivityDonut& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
...
public:
	...
	{
		double result;
		InvokeHelper(0x1f6, DISPATCH_PROPERTYGET, VT_R8, (void*)&result, nullptr);
		return result;
	}
	...
	{
		unsigned long result;
		InvokeHelper(0x1f8, DISPATCH_PROPERTYGET, VT_UI4, (void*)&result, nullptr);
		return result;
	}
