...
// CCustomImagePointSeries wrapper class

class CCustomImagePointSeries : public COleDispatchDriver
{
public:
	CCustomImagePointSeries() {} // Calls COleDispatchDriver default constructor
...
public:
	...
	// ICustomImagePointSeries methods
public:
	...
	// ICustomImagePointSeries properties
public:
