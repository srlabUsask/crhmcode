...
{
InstrumentLogger::instance()->log_instrument_log("<ClassSnobalX::klone(string name) const@@@ClassSnobalX.cpp>");
...
{
InstrumentLogger::instance()->log_instrument_log("<ClassSnobalX::decl(void)@@@ClassSnobalX.cpp>");
...
{
InstrumentLogger::instance()->log_instrument_log("<ClassSnobalX::init(void)@@@ClassSnobalX.cpp>");
    ClassSnobalBase :: init ();
InstrumentLogger::instance()->log_instrument_log("</ClassSnobalX::init(void)@@@ClassSnobalX.cpp>");
}
void ClassSnobalX :: run (void)
{
InstrumentLogger::instance()->log_instrument_log("<ClassSnobalX::run(void)@@@ClassSnobalX.cpp>");
    if (getstep () == 1)
    {
...
void ClassSnobalX :: finish (bool good)
{
InstrumentLogger::instance()->log_instrument_log("<ClassSnobalX::finish(bool good)@@@ClassSnobalX.cpp>");
