...
{
InstrumentLogger::instance()->log_instrument_log("<ClassFlowInSnow::klone(string name) const@@@ClassFlowInSnow.cpp>");
...
{
InstrumentLogger::instance()->log_instrument_log("<ClassFlowInSnow::decl(void)@@@ClassFlowInSnow.cpp>");
...
{
InstrumentLogger::instance()->log_instrument_log("<ClassFlowInSnow::init(void)@@@ClassFlowInSnow.cpp>");
...
{
InstrumentLogger::instance()->log_instrument_log("<ClassFlowInSnow::run(void)@@@ClassFlowInSnow.cpp>");
