...
InstrumentLogger::instance()->log_instrument_log("<Classobs::decl(void)@@@ClassObs.cpp>");
    ...
    decldiagparam ("tmax_allrain", TDim :: NHRU, "[4.0]", "-10", "10", "precip all rain if HRU air/ice bulb temperature above or equal to this value. Not used in Harder method.", "(°C)", & tmax_allrain);
    decldiagparam ("tmax_allsnow", TDim :: NHRU, "[0.0]", "-10", "10", "precip all snow if HRU air/ice bulb temperature below this value. Not used in Harder method", "(°C)", & tmax_allsnow);
