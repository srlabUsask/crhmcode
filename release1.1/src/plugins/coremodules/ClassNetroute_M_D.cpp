...
{
InstrumentLogger::instance()->log_instrument_log("<ClassNetroute_M_D::klone(string name) const@@@ClassNetroute_M_D.cpp>");
...
{
InstrumentLogger::instance()->log_instrument_log("<ClassNetroute_M_D::Function1(double * I, long hh)@@@ClassNetroute_M_D.cpp>");
...
{
InstrumentLogger::instance()->log_instrument_log("<ClassNetroute_M_D::Function2(double * X, long hh)@@@ClassNetroute_M_D.cpp>");
...
{
InstrumentLogger::instance()->log_instrument_log("<ClassNetroute_M_D::decl(void)@@@ClassNetroute_M_D.cpp>");
...
{
InstrumentLogger::instance()->log_instrument_log("<ClassNetroute_M_D::init(void)@@@ClassNetroute_M_D.cpp>");
...
{
InstrumentLogger::instance()->log_instrument_log("<ClassNetroute_M_D::run(void)@@@ClassNetroute_M_D.cpp>");
    long nstep = getstep ();
...
{
InstrumentLogger::instance()->log_instrument_log("<ClassNetroute_M_D::finish(bool good)@@@ClassNetroute_M_D.cpp>");
