...
{
InstrumentLogger::instance()->log_instrument_log("<ClassNetroute::klone(string name) const@@@ClassNetroute.cpp>");
...
{
InstrumentLogger::instance()->log_instrument_log("<ClassNetroute::Function1(double * I, long hh)@@@ClassNetroute.cpp>");
...
{
InstrumentLogger::instance()->log_instrument_log("<ClassNetroute::Function2(double * X, long hh)@@@ClassNetroute.cpp>");
...
{
InstrumentLogger::instance()->log_instrument_log("<ClassNetroute::decl(void)@@@ClassNetroute.cpp>");
...
{
InstrumentLogger::instance()->log_instrument_log("<ClassNetroute::init(void)@@@ClassNetroute.cpp>");
...
{
InstrumentLogger::instance()->log_instrument_log("<ClassNetroute::run(void)@@@ClassNetroute.cpp>");
    long step = getstep ();
    ...
    for (long jj = 0; chkStruct (jj); ++ jj) {
        ...
        hruDelay -> DoClark (hh);
        if (whereto [hh] == 0 && outflow [hh] > 0.0)
        {
...
{
InstrumentLogger::instance()->log_instrument_log("<ClassNetroute::finish(bool good)@@@ClassNetroute.cpp>");
