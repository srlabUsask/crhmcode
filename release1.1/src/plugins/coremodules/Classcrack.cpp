...
{
InstrumentLogger::instance()->log_instrument_log("<Classcrack::klone(string name) const@@@Classcrack.cpp>");
...
{
InstrumentLogger::instance()->log_instrument_log("<Classcrack::decl(void)@@@Classcrack.cpp>");
...
{
InstrumentLogger::instance()->log_instrument_log("<Classcrack::init(void)@@@Classcrack.cpp>");
...
{
InstrumentLogger::instance()->log_instrument_log("<Classcrack::run(void)@@@Classcrack.cpp>");
    long nstep;
...
{
InstrumentLogger::instance()->log_instrument_log("<Classcrack::finish(bool good)@@@Classcrack.cpp>");
    for (hh = 0; chkStruct (); ++ hh) {
