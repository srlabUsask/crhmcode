...
InstrumentLogger::instance()->log_instrument_log("</CRHMmain::DoPrjOpen(string OpenNamePrj, string PD)@@@CRHMmain.cpp>");
                    ...
                    else
                    {
                        ...
                        {
                            CRHMException Except ("Unknown Module Parameter: " + string (module) + " -> " + string (param) + " in " + OpenNamePrj, TExcept :: ERR);
                            LogError (Except);
                        }
...
{
InstrumentLogger::instance()->log_instrument_log("<CRHMmain::FormCreate(void)@@@CRHMmain.cpp>");
