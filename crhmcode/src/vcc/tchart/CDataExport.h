...
// CDataExport wrapper class

class CDataExport : public COleDispatchDriver
{
public:
	CDataExport() {} // Calls COleDispatchDriver default constructor
	CDataExport(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	CDataExport(const CDataExport& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
