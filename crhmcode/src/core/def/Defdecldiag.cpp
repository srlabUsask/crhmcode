...
{
InstrumentLogger::instance()->log_instrument_log("<Defdecldiag::Defdecldiag(ClassMacro * Macro_): DefCRHM (Macro_)@@@Defdecldiag.cpp>");
...
{
InstrumentLogger::instance()->log_instrument_log("<Defdecldiag::CallDecl()@@@Defdecldiag.cpp>");
    if (Int)
    {
...
{
InstrumentLogger::instance()->log_instrument_log("<Defdecldiag::CallInit(long nhru, long nlay)@@@Defdecldiag.cpp>");
