...
Convert :: Convert ()
{
InstrumentLogger::instance()->log_instrument_log("<Convert::Convert()@@@Convert.cpp>");
    NumUnits = 0;
    NumBasicUnits = 0;
    NumMultipliers = 0;
...
InstrumentLogger::instance()->log_instrument_log("</Convert::Convert()@@@Convert.cpp>");
      ...
      "m"), Unit_Info ("m", "Meter", 1, ""), Unit_Info ("mho", "Mho", 1, "A^2*s^2/Kg*m^2"), Unit_Info ("mi", "InternationalMile", 1609.344, "m"), Unit_Info ("miUS", "USStatuteMile", 1609.34721869, "m"), Unit_Info ("mil", "Mil", 0.0000254, "m"), Unit_Info ("min", "Minute", 60, "s"), Unit_Info ("mmHg", "MilimeterOfMercury", 133.322368421, "Kg/m*s^2"), Unit_Info ("mol", "Mole", 1, ""), Unit_Info ("mph", "MilesPerHour", 0.44704, "m/s"), Unit_Info ("nmi", "NauticalMile", 1852, "m"), Unit_Info ("oz", "Ounce", 0.028349523125, "Kg"), Unit_Info ("ozfl", "USFluidOunce", 2.95735295625e-5, "m^3"), Unit_Info ("ozt", "TroyOunce", 0.0311034768, "Kg"), Unit_Info ("pc", "Parsec", 3.08567818585106, "m"), Unit_Info ("ph", "Phot", 10000, "cd*sr/m^2"), Unit_Info ("pk", "Peck", 0.0088097675, "m^3"), Unit_Info ("psi", "PoundsPerSquareInch", 6894.75729317, "Kg/m*s^2"), Unit_Info ("pt", "Pint", 0.000473176473, "m^3"), Unit_Info ("qt", "Quart", 0.000946352946, "m^3"), Unit_Info ("r", "Radian", 1, ""), Unit_Info ("rad", "Rad", 0.01, "m^2/s^2"), Unit_Info ("rd", "Rod", 5.02921005842, "m"), Unit_Info ("rem", "Rem", 0.01, "m^2/s^2"), Unit_Info ("s", "Second", 1, ""), Unit_Info ("sb", "Stilb", 10000, "cd/m^2"), Unit_Info ("slug", "Slug", 14.5939029372, "Kg"), Unit_Info ("sr", "Steradian", 1, ""), Unit_Info ("st", "Stere", 1, "m^3"), Unit_Info ("t", "MetricTon", 1000, "Kg"), Unit_Info ("tbsp", "Tablespoon", 1.47867647813e-5, "m^3"), Unit_Info ("therm", "EECTherm", 105506000, "Kg*m^2/s^2"), Unit_Info ("ton", "ShortTon", 907.18474, "Kg"), Unit_Info ("tonUK", "UKLongTon", 1016.0469088, "Kg"), Unit_Info ("torr", "Torr", 133.322368421, "Kg/m^2"), Unit_Info ("tsp", "Teaspoon", 4.92892159375e-6, "m^3"), Unit_Info ("yd", "InternationalYard", 0.9144, "m"), Unit_Info ("yr", "Year", 31556925.9747, "s"), Unit_Info (DEGREE, "Degree", 1.74532925199e-2, "r"), Unit_Info (DEGREE_CELSIUS, "DegreeCelsius", 1.0, "K"), Unit_Info (DEGREE_FAHRENHEIT, "DegreesFahrenheit", 1.0 / 1.8, "K"), Unit_Info (DEGREE_RANKINE,
      "DegreesRankine", 1.0 / 1.8, "K"), Unit_Info (MICRON, "Micron", 1e-6, "m"), Unit_Info (ANGSTROM, "Angstrom", 1e-10, "m"), Unit_Info ("", "", 0, "")};
...
{
InstrumentLogger::instance()->log_instrument_log("<tcsinc(string pszIn)@@@Convert.cpp>");
...
{
InstrumentLogger::instance()->log_instrument_log("<tcsSkipSpaces(string pszIn)@@@Convert.cpp>");
...
{
InstrumentLogger::instance()->log_instrument_log("<tcsSqueeze(string pszIn)@@@Convert.cpp>");
    string :: iterator pos;
...
{
InstrumentLogger::instance()->log_instrument_log("<Convert::ConvertUnit(double & dValue, string pszSrcUnit, string pszDstUnit)@@@Convert.cpp>");
...
{
InstrumentLogger::instance()->log_instrument_log("<Convert::quickPow(double k, int nPow)@@@Convert.cpp>");
...
{
InstrumentLogger::instance()->log_instrument_log("<Convert::LookupUnit(string pszIn)@@@Convert.cpp>");
    int iFirst = 0;
    int iLast = NumUnits;
    int i;
    string :: size_type Idx;
...
{
InstrumentLogger::instance()->log_instrument_log("<Convert::SetBasicUnit(Tresult & u, double k, int iUnit)@@@Convert.cpp>");
    u.k = k;
...
{
InstrumentLogger::instance()->log_instrument_log("<Convert::ExpandUnitExpr(Tresult & u, double k, string pszExpr)@@@Convert.cpp>");
...
{
InstrumentLogger::instance()->log_instrument_log("<Convert::ParseDivUnitExpr(string pszIn, Tresult & u)@@@Convert.cpp>");
...
{
InstrumentLogger::instance()->log_instrument_log("<Convert::ParseMulUnitExpr(string pszIn, Tresult & u)@@@Convert.cpp>");
...
{
InstrumentLogger::instance()->log_instrument_log("<Convert::ParsePowUnitExpr(string pszIn, Tresult & u)@@@Convert.cpp>");
...
{
InstrumentLogger::instance()->log_instrument_log("<Convert::ParseUnitPhase1(string pszIn, Tresult & u)@@@Convert.cpp>");
    string pszMark = pszIn;
...
{
InstrumentLogger::instance()->log_instrument_log("<Convert::ParseUnitPhase2(string pszIn, Tresult & u)@@@Convert.cpp>");
...
{
InstrumentLogger::instance()->log_instrument_log("<Convert::CheckUnitsTable()@@@Convert.cpp>");
    bool bSuccess = true;
...
{
InstrumentLogger::instance()->log_instrument_log("<Convert::CheckUnitsString(string Name, string variable, string units)@@@Convert.cpp>");
    string temp (units);
...
{
InstrumentLogger::instance()->log_instrument_log("<Convert::CheckUnitsObs(string Vunits, string Munits, string declaration)@@@Convert.cpp>");
    double d;
    if (! Vunits.empty ())
    {
