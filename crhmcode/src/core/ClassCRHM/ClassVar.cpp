...
{
InstrumentLogger::instance()->log_instrument_log("<ClassVar::BackUp()@@@ClassVar.cpp>");
    long Fix = lay;
    if (lay == 0)
    {
        Fix = 1;
...
{
InstrumentLogger::instance()->log_instrument_log("<ClassVar::Restore()@@@ClassVar.cpp>");
    long Fix = lay;
    if (lay == 0)
    {
        Fix = 1;
...
{
InstrumentLogger::instance()->log_instrument_log("<ClassVar::ClassVar(const ClassVar & Cl)@@@ClassVar.cpp>");
    module = Cl.module;
    root = Cl.root;
    name = Cl.name;
    help = Cl.help;
...
{
InstrumentLogger::instance()->log_instrument_log("<ClassVar::operator=(const ClassVar & Cl)@@@ClassVar.cpp>");
    if (this == & Cl)
    {
...
{
InstrumentLogger::instance()->log_instrument_log("<ClassVar::ReleaseM(bool Keep)@@@ClassVar.cpp>");
    if (! values && ! ivalues)
    {
...
{
InstrumentLogger::instance()->log_instrument_log("<ClassVar::ReadVar(void)@@@ClassVar.cpp>");
...
{
InstrumentLogger::instance()->log_instrument_log("<ClassVar::WriteVar(void)@@@ClassVar.cpp>");
    if (FileData -> Times == NULL)
    {
        if (varType == TVar :: ReadF || varType == TVar :: Read)
        {
...
{
InstrumentLogger::instance()->log_instrument_log("<ClassVar::LoopFirst(long dim_n)@@@ClassVar.cpp>");
...
{
InstrumentLogger::instance()->log_instrument_log("<ClassVar::LoopLast(long dim_n)@@@ClassVar.cpp>");
...
{
InstrumentLogger::instance()->log_instrument_log("<ClassVar::LoopRange(long dim_n)@@@ClassVar.cpp>");
    Index_ = Global :: DTindx / FunctVar -> FileData -> ModN;
    do {
        (this ->* (this -> UserFunct_)) (dim_n);
    }
...
{
InstrumentLogger::instance()->log_instrument_log("<GetSharedUnitVar(string units)@@@ClassVar.cpp>");
...
{
InstrumentLogger::instance()->log_instrument_log("<ClassVar::GetUnit(void)@@@ClassVar.cpp>");
