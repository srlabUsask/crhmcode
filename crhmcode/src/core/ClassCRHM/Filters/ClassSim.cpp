...
{
InstrumentLogger::instance()->log_instrument_log("<ClassSim::ClassSim(ClassData * MyObs, string ToVar, string args, string argtypes): Classfilter (MyObs, ToVar, args, argtypes)@@@ClassSim.cpp>");
    readargs ();
...
{
InstrumentLogger::instance()->log_instrument_log("<ClassSim::doFunc(long Obs, long Line)@@@ClassSim.cpp>");
InstrumentLogger::instance()->log_instrument_log("</ClassSim::doFunc(long Obs, long Line)@@@ClassSim.cpp>");
}