...
{
InstrumentLogger::instance()->log_instrument_log("<ClassPar::ExpandShrink(long new_dim)@@@ClassPar.cpp>");
    if (varType == TVar :: Txt)
    {
...
{
InstrumentLogger::instance()->log_instrument_log("<ClassPar::BackUp()@@@ClassPar.cpp>");
    if (varType == TVar :: Txt)
    {
        StringsBkup = new TStringList;
        StringsBkup -> Assign (Strings);
...
{
InstrumentLogger::instance()->log_instrument_log("<ClassPar::Restore()@@@ClassPar.cpp>");
    if (varType == TVar :: Txt)
    {
...
{
InstrumentLogger::instance()->log_instrument_log("<ClassPar::ClassPar(ClassPar & p)@@@ClassPar.cpp>");
...
{
InstrumentLogger::instance()->log_instrument_log("<ClassPar::Same(ClassPar & p)@@@ClassPar.cpp>");
...
{
InstrumentLogger::instance()->log_instrument_log("<ClassPar::Change(ClassPar & p)@@@ClassPar.cpp>");
    if (this == & p)
    {
...
{
InstrumentLogger::instance()->log_instrument_log("<GetSharedUnitPar(string units)@@@ClassPar.cpp>");
...
{
InstrumentLogger::instance()->log_instrument_log("<ClassPar::GetUnit(void)@@@ClassPar.cpp>");
