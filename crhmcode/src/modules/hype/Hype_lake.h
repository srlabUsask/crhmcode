...
public:
	...
	void oc_processes_in_lake(const long watertype, const long area, const long prodpar, const long limpppar, const long sedocpar);
	...
	void oc_sedimentation(const float area, const float sedocpar);
};
