...
class ClassNetroute_M2_D : public ClassModule {
public:

ClassNetroute_M2_D(string Name, string Version = "undefined", LMODULE Lvl = LMODULE::PROTO) : ClassModule(Name, Version, Lvl) {};
...
ClassNetroute_M2_D* klone(string name) const;
};
