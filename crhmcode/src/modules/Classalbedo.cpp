...
{
InstrumentLogger::instance()->log_instrument_log("<Classalbedo::klone(string name) const@@@Classalbedo.cpp>");
...
{
InstrumentLogger::instance()->log_instrument_log("<Classalbedo::decl(void)@@@Classalbedo.cpp>");
...
{
InstrumentLogger::instance()->log_instrument_log("<Classalbedo::init(void)@@@Classalbedo.cpp>");
...
{
InstrumentLogger::instance()->log_instrument_log("<Classalbedo::run(void)@@@Classalbedo.cpp>");
    long nstep, jday;
