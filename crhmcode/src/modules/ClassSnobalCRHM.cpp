...
{
InstrumentLogger::instance()->log_instrument_log("<ClassSnobalCRHM::klone(string name) const@@@ClassSnobalCRHM.cpp>");
...
{
InstrumentLogger::instance()->log_instrument_log("<ClassSnobalCRHM::decl(void)@@@ClassSnobalCRHM.cpp>");
    ...
    declgetvar ("*", "hru_t", "(" + string (DEGREE_CELSIUS) + ")", & T_pp_X);
...
{
InstrumentLogger::instance()->log_instrument_log("<ClassSnobalCRHM::init(void)@@@ClassSnobalCRHM.cpp>");
...
void ClassSnobalCRHM :: run (void)
{
InstrumentLogger::instance()->log_instrument_log("<ClassSnobalCRHM::run(void)@@@ClassSnobalCRHM.cpp>");
    ...
    for (hh = 0; chkStruct (); ++ hh) {
        ...
        if (rain_soil_snow [hh] && snowcover [hh])
        {
...
void ClassSnobalCRHM :: finish (bool good)
{
InstrumentLogger::instance()->log_instrument_log("<ClassSnobalCRHM::finish(bool good)@@@ClassSnobalCRHM.cpp>");
