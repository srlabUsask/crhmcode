...
{
InstrumentLogger::instance()->log_instrument_log("<Classglacier_debris::klone(string name) const@@@Classglacier_debris.cpp>");
...
{
InstrumentLogger::instance()->log_instrument_log("<Classglacier_debris::decl(void)@@@Classglacier_debris.cpp>");
...
{
InstrumentLogger::instance()->log_instrument_log("<Classglacier_debris::init(void)@@@Classglacier_debris.cpp>");
...
{
InstrumentLogger::instance()->log_instrument_log("<Classglacier_debris::run(void)@@@Classglacier_debris.cpp>");
    ...
    for (hh = 0; chkStruct (); ++ hh) {
        ...
        if (variation == VARIATION_5)
        {
            ...
            {
                Xmelt_acc [hh] = Xmelt_acc [hh] + Xmelt_int [hh];
            }
...
{
InstrumentLogger::instance()->log_instrument_log("<Classglacier_debris::finish(bool good)@@@Classglacier_debris.cpp>");
...
double Classglacier_debris :: DepthofSnow (double SWE)
{
InstrumentLogger::instance()->log_instrument_log("<Classglacier_debris::DepthofSnow(double SWE)@@@Classglacier_debris.cpp>");
    double rho;
    if (SWE > 1.0)
    {
