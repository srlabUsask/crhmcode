...
{
InstrumentLogger::instance()->log_instrument_log("<ClassCRHMCanopyClearing::klone(string name) const@@@ClassCRHMCanopyClearing.cpp>");
...
{
InstrumentLogger::instance()->log_instrument_log("<ClassCRHMCanopyClearing::decl(void)@@@ClassCRHMCanopyClearing.cpp>");
...
{
InstrumentLogger::instance()->log_instrument_log("<ClassCRHMCanopyClearing::init(void)@@@ClassCRHMCanopyClearing.cpp>");
...
{
InstrumentLogger::instance()->log_instrument_log("<ClassCRHMCanopyClearing::run(void)@@@ClassCRHMCanopyClearing.cpp>");
    double Kstar_H;
...
{
InstrumentLogger::instance()->log_instrument_log("<ClassCRHMCanopyClearing::finish(bool good)@@@ClassCRHMCanopyClearing.cpp>");
    for (hh = 0; chkStruct (); ++ hh) {
...
double ClassCRHMCanopyClearing :: delta (double t)
{
InstrumentLogger::instance()->log_instrument_log("<ClassCRHMCanopyClearing::delta(double t)@@@ClassCRHMCanopyClearing.cpp>");
    if (t > 0.0)
    {
...
double ClassCRHMCanopyClearing :: lambda (double t)
{
InstrumentLogger::instance()->log_instrument_log("<ClassCRHMCanopyClearing::lambda(double t)@@@ClassCRHMCanopyClearing.cpp>");

InstrumentLogger::instance()->log_instrument_log("</ClassCRHMCanopyClearing::lambda(double t)@@@ClassCRHMCanopyClearing.cpp>");
    return (2.501 - 0.002361 * t);
InstrumentLogger::instance()->log_instrument_log("</ClassCRHMCanopyClearing::lambda(double t)@@@ClassCRHMCanopyClearing.cpp>");
}
double ClassCRHMCanopyClearing :: gamma (double Pa, double t)
{
InstrumentLogger::instance()->log_instrument_log("<ClassCRHMCanopyClearing::gamma(double Pa, double t)@@@ClassCRHMCanopyClearing.cpp>");

InstrumentLogger::instance()->log_instrument_log("</ClassCRHMCanopyClearing::gamma(double Pa, double t)@@@ClassCRHMCanopyClearing.cpp>");
    return (0.00163 * Pa / lambda (t));
InstrumentLogger::instance()->log_instrument_log("</ClassCRHMCanopyClearing::gamma(double Pa, double t)@@@ClassCRHMCanopyClearing.cpp>");
}
double ClassCRHMCanopyClearing :: RHOa (double t, double ea, double Pa)
{
InstrumentLogger::instance()->log_instrument_log("<ClassCRHMCanopyClearing::RHOa(double t, double ea, double Pa)@@@ClassCRHMCanopyClearing.cpp>");
    const double R = 2870;
