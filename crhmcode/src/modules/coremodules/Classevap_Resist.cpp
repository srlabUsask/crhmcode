...
using namespace CRHM; string Evap_Resist_names [] = {"Penman-Monteith", "Dalton Bulk transfer", "Priestley_Taylor"};

Classevap_Resist * Classevap_Resist :: klone (string name) const
{
InstrumentLogger::instance()->log_instrument_log("<Classevap_Resist::klone(string name) const@@@Classevap_Resist.cpp>");
...
{
InstrumentLogger::instance()->log_instrument_log("<Classevap_Resist::decl(void)@@@Classevap_Resist.cpp>");
    ...
    declparam ("evap_type", TDim :: NHRU, "0", "0", "2", "Evaporation method for this HRU, 0 = Penman-Monteith, 1 = Dalton bulk transfer, 2 = Priestley-Taylor", "()", & evap_type);
...
{
InstrumentLogger::instance()->log_instrument_log("<Classevap_Resist::init(void)@@@Classevap_Resist.cpp>");
...
{
InstrumentLogger::instance()->log_instrument_log("<Classevap_Resist::run(void)@@@Classevap_Resist.cpp>");
    ...
    for (hh = 0; chkStruct (); ++ hh) {
        ...
        case 0:
            if (soil_moist [hh] > 0.0)
            {
                ...
                f2 = max < double > (1.0, 2.0 * (estar (hru_t [hh]) - hru_ea [hh]));
        ...
        case 1:
            if (soil_moist [hh] > 0.0)
            {
                ...
                double qs = 0.622 * Common :: estar (Ts [hh]) / (Pa [hh] - Common :: estar (Ts [hh]) * 0.378);
...
{
InstrumentLogger::instance()->log_instrument_log("<Classevap_Resist::finish(bool good)@@@Classevap_Resist.cpp>");
    for (hh = 0; chkStruct (); ++ hh) {
...
double Classevap_Resist :: gamma (double Pa, double t)
{
InstrumentLogger::instance()->log_instrument_log("<Classevap_Resist::gamma(double Pa, double t)@@@Classevap_Resist.cpp>");

InstrumentLogger::instance()->log_instrument_log("</Classevap_Resist::gamma(double Pa, double t)@@@Classevap_Resist.cpp>");
    return (0.00163 * Pa / lambda (t));
InstrumentLogger::instance()->log_instrument_log("</Classevap_Resist::gamma(double Pa, double t)@@@Classevap_Resist.cpp>");
}
double Classevap_Resist :: lambda (double t)
{
InstrumentLogger::instance()->log_instrument_log("<Classevap_Resist::lambda(double t)@@@Classevap_Resist.cpp>");

InstrumentLogger::instance()->log_instrument_log("</Classevap_Resist::lambda(double t)@@@Classevap_Resist.cpp>");
    return (2.501 - 0.002361 * t);
InstrumentLogger::instance()->log_instrument_log("</Classevap_Resist::lambda(double t)@@@Classevap_Resist.cpp>");
}
double Classevap_Resist :: delta (double t)
{
InstrumentLogger::instance()->log_instrument_log("<Classevap_Resist::delta(double t)@@@Classevap_Resist.cpp>");
    if (t > 0.0)
    {
...
double Classevap_Resist :: RHOa (double t, double ea, double Pa)
{
InstrumentLogger::instance()->log_instrument_log("<Classevap_Resist::RHOa(double t, double ea, double Pa)@@@Classevap_Resist.cpp>");
