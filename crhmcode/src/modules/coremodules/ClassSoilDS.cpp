...
{
InstrumentLogger::instance()->log_instrument_log("<ClassSoilDS::klone(string name) const@@@ClassSoilDS.cpp>");
...
{
InstrumentLogger::instance()->log_instrument_log("<ClassSoilDS::decl(void)@@@ClassSoilDS.cpp>");
...
{
InstrumentLogger::instance()->log_instrument_log("<ClassSoilDS::init(void)@@@ClassSoilDS.cpp>");
...
{
InstrumentLogger::instance()->log_instrument_log("<ClassSoilDS::run(void)@@@ClassSoilDS.cpp>");
...
{
InstrumentLogger::instance()->log_instrument_log("<ClassSoilDS::finish(bool good)@@@ClassSoilDS.cpp>");
