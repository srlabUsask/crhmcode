...
{
InstrumentLogger::instance()->log_instrument_log("<Classfrozen::klone(string name) const@@@Classfrozen.cpp>");
...
{
InstrumentLogger::instance()->log_instrument_log("<Classfrozen::decl(void)@@@Classfrozen.cpp>");
...
{
InstrumentLogger::instance()->log_instrument_log("<Classfrozen::init(void)@@@Classfrozen.cpp>");
...
{
InstrumentLogger::instance()->log_instrument_log("<Classfrozen::run(void)@@@Classfrozen.cpp>");
...
{
InstrumentLogger::instance()->log_instrument_log("<Classfrozen::finish(bool good)@@@Classfrozen.cpp>");
    for (hh = 0; chkStruct (); ++ hh) {
