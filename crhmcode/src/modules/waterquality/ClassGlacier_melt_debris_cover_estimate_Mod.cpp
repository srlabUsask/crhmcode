...
{
InstrumentLogger::instance()->log_instrument_log("<ClassGlacier_melt_debris_cover_estimate_Mod::klone(string name) const@@@ClassGlacier_melt_debris_cover_estimate_Mod.cpp>");
...
{
InstrumentLogger::instance()->log_instrument_log("<ClassGlacier_melt_debris_cover_estimate_Mod::decl(void)@@@ClassGlacier_melt_debris_cover_estimate_Mod.cpp>");
    long step = getstep ();
...
{
InstrumentLogger::instance()->log_instrument_log("<ClassGlacier_melt_debris_cover_estimate_Mod::init(void)@@@ClassGlacier_melt_debris_cover_estimate_Mod.cpp>");
    for (hh = 0; hh < nhru; ++ hh) {
        lagT [hh] = 0.0;
        lagSW [hh] = 0.0;
        Gmelt_energy [hh] = 0.0;
...
{
InstrumentLogger::instance()->log_instrument_log("<ClassGlacier_melt_debris_cover_estimate_Mod::run(void)@@@ClassGlacier_melt_debris_cover_estimate_Mod.cpp>");
