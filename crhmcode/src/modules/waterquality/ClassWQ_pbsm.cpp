...
{
InstrumentLogger::instance()->log_instrument_log("<ClassWQ_pbsm::klone(string name) const@@@ClassWQ_pbsm.cpp>");
...
{
InstrumentLogger::instance()->log_instrument_log("<ClassWQ_pbsm::decl(void)@@@ClassWQ_pbsm.cpp>");
...
{
InstrumentLogger::instance()->log_instrument_log("<ClassWQ_pbsm::init(void)@@@ClassWQ_pbsm.cpp>");
...
{
InstrumentLogger::instance()->log_instrument_log("<ClassWQ_pbsm::run(void)@@@ClassWQ_pbsm.cpp>");
...
{
InstrumentLogger::instance()->log_instrument_log("<ClassWQ_pbsm::finish(bool good)@@@ClassWQ_pbsm.cpp>");
    if (! good)
    {
...
{
InstrumentLogger::instance()->log_instrument_log("<ClassWQ_pbsm::Reset_WQ(long hru, double * var, double ** var_WQ_lay)@@@ClassWQ_pbsm.cpp>");
    var [hru] = 0.0;
    for (long Sub = 0; Sub < numsubstances; ++ Sub)
...
{
InstrumentLogger::instance()->log_instrument_log("<ClassWQ_pbsm::copy_array(double * from, double * to)@@@ClassWQ_pbsm.cpp>");
    for (hh = 0; chkStruct (); ++ hh)
        to [hh] = from [hh];
InstrumentLogger::instance()->log_instrument_log("</ClassWQ_pbsm::copy_array(double * from, double * to)@@@ClassWQ_pbsm.cpp>");
}
...
{
InstrumentLogger::instance()->log_instrument_log("<ClassWQ_pbsm::copy_array(long * from, long * to)@@@ClassWQ_pbsm.cpp>");
    for (hh = 0; chkStruct (); ++ hh)
        to [hh] = from [hh];
InstrumentLogger::instance()->log_instrument_log("</ClassWQ_pbsm::copy_array(long * from, long * to)@@@ClassWQ_pbsm.cpp>");
}
...
{
InstrumentLogger::instance()->log_instrument_log("<ClassWQ_pbsm::copy_basin(double * from, double * to)@@@ClassWQ_pbsm.cpp>");
    to [0] = from [0];
InstrumentLogger::instance()->log_instrument_log("</ClassWQ_pbsm::copy_basin(double * from, double * to)@@@ClassWQ_pbsm.cpp>");
}
void ClassWQ_pbsm :: restore_hru (double * from, double * to, long hh)
{
InstrumentLogger::instance()->log_instrument_log("<ClassWQ_pbsm::restore_hru(double * from, double * to, long hh)@@@ClassWQ_pbsm.cpp>");
    to [hh] = from [hh];
InstrumentLogger::instance()->log_instrument_log("</ClassWQ_pbsm::restore_hru(double * from, double * to, long hh)@@@ClassWQ_pbsm.cpp>");
}
void ClassWQ_pbsm :: restore_hru (long * from, long * to, long hh)
{
InstrumentLogger::instance()->log_instrument_log("<ClassWQ_pbsm::restore_hru(long * from, long * to, long hh)@@@ClassWQ_pbsm.cpp>");
    to [hh] = from [hh];
InstrumentLogger::instance()->log_instrument_log("</ClassWQ_pbsm::restore_hru(long * from, long * to, long hh)@@@ClassWQ_pbsm.cpp>");
}
void ClassWQ_pbsm :: Restore (long hh)
{
InstrumentLogger::instance()->log_instrument_log("<ClassWQ_pbsm::Restore(long hh)@@@ClassWQ_pbsm.cpp>");
...
{
InstrumentLogger::instance()->log_instrument_log("<ClassWQ_pbsm::Save()@@@ClassWQ_pbsm.cpp>");
