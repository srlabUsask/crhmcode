...
{
InstrumentLogger::instance()->log_instrument_log("<ClassWQ_Soil::klone(string name) const@@@ClassWQ_Soil.cpp>");
...
{
InstrumentLogger::instance()->log_instrument_log("<ClassWQ_Soil::decl(void)@@@ClassWQ_Soil.cpp>");
...
{
InstrumentLogger::instance()->log_instrument_log("<ClassWQ_Soil::init(void)@@@ClassWQ_Soil.cpp>");
...
{
InstrumentLogger::instance()->log_instrument_log("<ClassWQ_Soil::run(void)@@@ClassWQ_Soil.cpp>");
    try {
        ...
        string S = "Error" + string (" at ") + StandardConverterUtility :: GetDateTimeInString (Global :: DTnow) + " (" + to_string (getstep ()) + ") in '" + moduleName + "'" + " (" + FloatToStrF (Global :: DTnow, TFloatFormat :: ffGeneral, 10, 6) + ") hh = " + FloatToStrF (hh, TFloatFormat :: ffGeneral, 6, 0) + " Sub = " + FloatToStrF (Sub, TFloatFormat :: ffGeneral, 6, 0);
...
{
InstrumentLogger::instance()->log_instrument_log("<ClassWQ_Soil::finish(bool good)@@@ClassWQ_Soil.cpp>");
...
{
InstrumentLogger::instance()->log_instrument_log("<ClassWQ_Soil::FunctX(const double x)@@@ClassWQ_Soil.cpp>");
    double X = 0.0, F;
...
{
InstrumentLogger::instance()->log_instrument_log("<ClassWQ_Soil::Set_WQ(const long hru, double * var, double * var_cWQ, double amount, double amount_cWQ)@@@ClassWQ_Soil.cpp>");
    var [hru] = amount;
    if (amount > 0.0)
    {
...
{
InstrumentLogger::instance()->log_instrument_log("<ClassWQ_Soil::copy_array(double * from, double * to)@@@ClassWQ_Soil.cpp>");
    for (hh = 0; chkStruct (); ++ hh)
        to [hh] = from [hh];
InstrumentLogger::instance()->log_instrument_log("</ClassWQ_Soil::copy_array(double * from, double * to)@@@ClassWQ_Soil.cpp>");
}
...
{
InstrumentLogger::instance()->log_instrument_log("<ClassWQ_Soil::restore_hru(double * from, double * to, long hh)@@@ClassWQ_Soil.cpp>");
    to [hh] = from [hh];
InstrumentLogger::instance()->log_instrument_log("</ClassWQ_Soil::restore_hru(double * from, double * to, long hh)@@@ClassWQ_Soil.cpp>");
}
void ClassWQ_Soil :: Restore (long hh)
{
InstrumentLogger::instance()->log_instrument_log("<ClassWQ_Soil::Restore(long hh)@@@ClassWQ_Soil.cpp>");
...
{
InstrumentLogger::instance()->log_instrument_log("<ClassWQ_Soil::Save()@@@ClassWQ_Soil.cpp>");
...
{
InstrumentLogger::instance()->log_instrument_log("<ClassWQ_Soil::Reset_WQ(long hru, double * var, double * var_cWQ)@@@ClassWQ_Soil.cpp>");
    var [hru] = 0.0;
    var_cWQ [hru] = 0.0;
InstrumentLogger::instance()->log_instrument_log("</ClassWQ_Soil::Reset_WQ(long hru, double * var, double * var_cWQ)@@@ClassWQ_Soil.cpp>");
}
...
{
InstrumentLogger::instance()->log_instrument_log("<ClassWQ_Soil::Reset_WQ(long hru, double * var, double ** var_cWQ_lay)@@@ClassWQ_Soil.cpp>");
    var [hru] = 0.0;
    for (long Sub = 0; Sub < numsubstances; Sub ++) {
