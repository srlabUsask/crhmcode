...
{
InstrumentLogger::instance()->log_instrument_log("<ClassWQ_Netroute_M_D::decl(void)@@@ClassWQ_Netroute_M_D.cpp>");
...
{
InstrumentLogger::instance()->log_instrument_log("<ClassWQ_Netroute_M_D::init(void)@@@ClassWQ_Netroute_M_D.cpp>");
...
{
InstrumentLogger::instance()->log_instrument_log("<ClassWQ_Netroute_M_D::run(void)@@@ClassWQ_Netroute_M_D.cpp>");
    long step = getstep ();
...
{
InstrumentLogger::instance()->log_instrument_log("<ClassWQ_Netroute_M_D::finish(bool good)@@@ClassWQ_Netroute_M_D.cpp>");
...
{
InstrumentLogger::instance()->log_instrument_log("<ClassWQ_Netroute_M_D::Reset_WQ(long hru, double * var, double ** var_WQ_lay)@@@ClassWQ_Netroute_M_D.cpp>");
    var [hru] = 0.0;
    for (long Sub = 0; Sub < numsubstances; ++ Sub) {
...
{
InstrumentLogger::instance()->log_instrument_log("<ClassWQ_Netroute_M_D::Set_WQ(const long hru, double * var, double * var_conc, double Amount, double amount_conc)@@@ClassWQ_Netroute_M_D.cpp>");
    var [hru] = Amount;
    if (Amount > 0.0)
    {
...
{
InstrumentLogger::instance()->log_instrument_log("<ClassWQ_Netroute_M_D::copy_array(double * from, double * to)@@@ClassWQ_Netroute_M_D.cpp>");
    for (hh = 0; chkStruct (); ++ hh)
        to [hh] = from [hh];
InstrumentLogger::instance()->log_instrument_log("</ClassWQ_Netroute_M_D::copy_array(double * from, double * to)@@@ClassWQ_Netroute_M_D.cpp>");
}
...
{
InstrumentLogger::instance()->log_instrument_log("<ClassWQ_Netroute_M_D::restore_hru(double * from, double * to, long hh)@@@ClassWQ_Netroute_M_D.cpp>");
    to [hh] = from [hh];
InstrumentLogger::instance()->log_instrument_log("</ClassWQ_Netroute_M_D::restore_hru(double * from, double * to, long hh)@@@ClassWQ_Netroute_M_D.cpp>");
}
void ClassWQ_Netroute_M_D :: Restore (long hh)
{
InstrumentLogger::instance()->log_instrument_log("<ClassWQ_Netroute_M_D::Restore(long hh)@@@ClassWQ_Netroute_M_D.cpp>");
...
{
InstrumentLogger::instance()->log_instrument_log("<ClassWQ_Netroute_M_D::Save()@@@ClassWQ_Netroute_M_D.cpp>");
...
{
InstrumentLogger::instance()->log_instrument_log("<ClassWQ_Netroute_M_D::klone(string name) const@@@ClassWQ_Netroute_M_D.cpp>");
...
{
InstrumentLogger::instance()->log_instrument_log("<ClassWQ_Netroute_M_D::Function1(double * I, long hh)@@@ClassWQ_Netroute_M_D.cpp>");
...
{
InstrumentLogger::instance()->log_instrument_log("<ClassWQ_Netroute_M_D::Function2(double * X, long hh)@@@ClassWQ_Netroute_M_D.cpp>");
