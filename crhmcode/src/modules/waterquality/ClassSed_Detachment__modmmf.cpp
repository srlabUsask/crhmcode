...
// Parameters for the modified MMF formulation
  ...
  declparam("sfcslope", TDim::NHRU, "[0.0001]", "0","10", "slope of the interrills", "()", &sfcslope);
...
//  declparam("channel_pct", TDim::NHRU, "[0]", "0","100", "fraction of area containing rills", "()", &channel_pct);
  declparam("channel_slope", TDim::NHRU, "[0.0001]", "0","10", "slope of the rill channels", "()", &channel_slope);
...
void ClassSed_Detachment::calc_sed_balance(sed_triple &rslt) {   // g/m2
