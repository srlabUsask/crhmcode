...
{
InstrumentLogger::instance()->log_instrument_log("<ClassWQ_pbsmSnobal::klone(string name) const@@@ClassWQ_pbsmSnobal.cpp>");
...
{
InstrumentLogger::instance()->log_instrument_log("<ClassWQ_pbsmSnobal::decl(void)@@@ClassWQ_pbsmSnobal.cpp>");
...
{
InstrumentLogger::instance()->log_instrument_log("<ClassWQ_pbsmSnobal::init(void)@@@ClassWQ_pbsmSnobal.cpp>");
...
{
InstrumentLogger::instance()->log_instrument_log("<ClassWQ_pbsmSnobal::run(void)@@@ClassWQ_pbsmSnobal.cpp>");
...
{
InstrumentLogger::instance()->log_instrument_log("<ClassWQ_pbsmSnobal::finish(bool good)@@@ClassWQ_pbsmSnobal.cpp>");
    if (! good)
    {
...
{
InstrumentLogger::instance()->log_instrument_log("<ClassWQ_pbsmSnobal::Reset_WQ(long hru, double * var, double ** var_WQ_lay)@@@ClassWQ_pbsmSnobal.cpp>");
    var [hru] = 0.0;
    for (long Sub = 0; Sub < numsubstances; ++ Sub)
...
{
InstrumentLogger::instance()->log_instrument_log("<ClassWQ_pbsmSnobal::copy_array(double * from, double * to)@@@ClassWQ_pbsmSnobal.cpp>");
    for (hh = 0; chkStruct (); ++ hh)
        to [hh] = from [hh];
InstrumentLogger::instance()->log_instrument_log("</ClassWQ_pbsmSnobal::copy_array(double * from, double * to)@@@ClassWQ_pbsmSnobal.cpp>");
}
...
{
InstrumentLogger::instance()->log_instrument_log("<ClassWQ_pbsmSnobal::copy_array(long * from, long * to)@@@ClassWQ_pbsmSnobal.cpp>");
    for (hh = 0; chkStruct (); ++ hh)
        to [hh] = from [hh];
InstrumentLogger::instance()->log_instrument_log("</ClassWQ_pbsmSnobal::copy_array(long * from, long * to)@@@ClassWQ_pbsmSnobal.cpp>");
}
...
{
InstrumentLogger::instance()->log_instrument_log("<ClassWQ_pbsmSnobal::copy_basin(double * from, double * to)@@@ClassWQ_pbsmSnobal.cpp>");
    to [0] = from [0];
InstrumentLogger::instance()->log_instrument_log("</ClassWQ_pbsmSnobal::copy_basin(double * from, double * to)@@@ClassWQ_pbsmSnobal.cpp>");
}
void ClassWQ_pbsmSnobal :: restore_hru (double * from, double * to, long hh)
{
InstrumentLogger::instance()->log_instrument_log("<ClassWQ_pbsmSnobal::restore_hru(double * from, double * to, long hh)@@@ClassWQ_pbsmSnobal.cpp>");
    to [hh] = from [hh];
InstrumentLogger::instance()->log_instrument_log("</ClassWQ_pbsmSnobal::restore_hru(double * from, double * to, long hh)@@@ClassWQ_pbsmSnobal.cpp>");
}
void ClassWQ_pbsmSnobal :: restore_hru (long * from, long * to, long hh)
{
InstrumentLogger::instance()->log_instrument_log("<ClassWQ_pbsmSnobal::restore_hru(long * from, long * to, long hh)@@@ClassWQ_pbsmSnobal.cpp>");
    to [hh] = from [hh];
InstrumentLogger::instance()->log_instrument_log("</ClassWQ_pbsmSnobal::restore_hru(long * from, long * to, long hh)@@@ClassWQ_pbsmSnobal.cpp>");
}
void ClassWQ_pbsmSnobal :: Restore (long hh)
{
InstrumentLogger::instance()->log_instrument_log("<ClassWQ_pbsmSnobal::Restore(long hh)@@@ClassWQ_pbsmSnobal.cpp>");
...
{
InstrumentLogger::instance()->log_instrument_log("<ClassWQ_pbsmSnobal::Save()@@@ClassWQ_pbsmSnobal.cpp>");
