...
{
InstrumentLogger::instance()->log_instrument_log("<ClassWQ_Gen_Mass_Var_Soil::klone(string name) const@@@ClassWQ_Gen_Mass_Var_Soil.cpp>");
...
{
InstrumentLogger::instance()->log_instrument_log("<ClassWQ_Gen_Mass_Var_Soil::decl(void)@@@ClassWQ_Gen_Mass_Var_Soil.cpp>");
...
{
InstrumentLogger::instance()->log_instrument_log("<ClassWQ_Gen_Mass_Var_Soil::init(void)@@@ClassWQ_Gen_Mass_Var_Soil.cpp>");
...
{
InstrumentLogger::instance()->log_instrument_log("<ClassWQ_Gen_Mass_Var_Soil::run(void)@@@ClassWQ_Gen_Mass_Var_Soil.cpp>");
    for (long Sub = 0; Sub < numsubstances; ++ Sub) {
        double temp;
        for (hh = 0; chkStruct (); ++ hh) {
...
{
InstrumentLogger::instance()->log_instrument_log("<ClassWQ_Gen_Mass_Var_Soil::finish(bool good)@@@ClassWQ_Gen_Mass_Var_Soil.cpp>");
