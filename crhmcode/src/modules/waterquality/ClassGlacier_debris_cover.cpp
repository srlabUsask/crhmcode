...
{
InstrumentLogger::instance()->log_instrument_log("<ClassGlacier_debris_cover::klone(string name) const@@@ClassGlacier_debris_cover.cpp>");
...
{
InstrumentLogger::instance()->log_instrument_log("<ClassGlacier_debris_cover::decl(void)@@@ClassGlacier_debris_cover.cpp>");
    long step = getstep ();
...
{
InstrumentLogger::instance()->log_instrument_log("<ClassGlacier_debris_cover::init(void)@@@ClassGlacier_debris_cover.cpp>");
    for (hh = 0; hh < nhru; ++ hh) {
        lagT [hh] = 0.0;
        lagSW [hh] = 0.0;
        Xmelt [hh] = 0.0;
...
{
InstrumentLogger::instance()->log_instrument_log("<ClassGlacier_debris_cover::run(void)@@@ClassGlacier_debris_cover.cpp>");
    double TF = 0.0;
    double SRF = 0.0;
    long nstep = getstep ();
