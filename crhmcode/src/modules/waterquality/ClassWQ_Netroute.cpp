...
{
InstrumentLogger::instance()->log_instrument_log("<ClassWQ_Netroute::klone(string name) const@@@ClassWQ_Netroute.cpp>");
...
{
InstrumentLogger::instance()->log_instrument_log("<ClassWQ_Netroute::decl(void)@@@ClassWQ_Netroute.cpp>");
...
{
InstrumentLogger::instance()->log_instrument_log("<ClassWQ_Netroute::init(void)@@@ClassWQ_Netroute.cpp>");
...
{
InstrumentLogger::instance()->log_instrument_log("<ClassWQ_Netroute::run(void)@@@ClassWQ_Netroute.cpp>");
    long step = getstep ();
...
{
InstrumentLogger::instance()->log_instrument_log("<ClassWQ_Netroute::finish(bool good)@@@ClassWQ_Netroute.cpp>");
...
{
InstrumentLogger::instance()->log_instrument_log("<ClassWQ_Netroute::Function1(double * I, long hh)@@@ClassWQ_Netroute.cpp>");
...
{
InstrumentLogger::instance()->log_instrument_log("<ClassWQ_Netroute::Function2(double * X, long hh)@@@ClassWQ_Netroute.cpp>");
...
{
InstrumentLogger::instance()->log_instrument_log("<ClassWQ_Netroute::Reset_WQ(long hru, double * var, double ** var_cWQ_lay)@@@ClassWQ_Netroute.cpp>");
    var [hru] = 0.0;
    for (long Sub = 0; Sub < numsubstances; ++ Sub) {
...
{
InstrumentLogger::instance()->log_instrument_log("<ClassWQ_Netroute::Set_WQ(const long hru, double * var, double * var_conc, double Amount, double amount_conc)@@@ClassWQ_Netroute.cpp>");
    var [hru] = Amount;
    if (Amount > 0.0)
    {
...
{
InstrumentLogger::instance()->log_instrument_log("<ClassWQ_Netroute::copy_array(double * from, double * to)@@@ClassWQ_Netroute.cpp>");
    for (hh = 0; chkStruct (); ++ hh)
        to [hh] = from [hh];
InstrumentLogger::instance()->log_instrument_log("</ClassWQ_Netroute::copy_array(double * from, double * to)@@@ClassWQ_Netroute.cpp>");
}
...
{
InstrumentLogger::instance()->log_instrument_log("<ClassWQ_Netroute::restore_hru(double * from, double * to, long hh)@@@ClassWQ_Netroute.cpp>");
    to [hh] = from [hh];
InstrumentLogger::instance()->log_instrument_log("</ClassWQ_Netroute::restore_hru(double * from, double * to, long hh)@@@ClassWQ_Netroute.cpp>");
}
void ClassWQ_Netroute :: Restore (long hh)
{
InstrumentLogger::instance()->log_instrument_log("<ClassWQ_Netroute::Restore(long hh)@@@ClassWQ_Netroute.cpp>");
...
{
InstrumentLogger::instance()->log_instrument_log("<ClassWQ_Netroute::Save()@@@ClassWQ_Netroute.cpp>");
