...
{
InstrumentLogger::instance()->log_instrument_log("<ClassPrairieInfil::klone(string name) const@@@ClassPrairieInfil.cpp>");
...
{
InstrumentLogger::instance()->log_instrument_log("<ClassPrairieInfil::decl(void)@@@ClassPrairieInfil.cpp>");
...
{
InstrumentLogger::instance()->log_instrument_log("<ClassPrairieInfil::init(void)@@@ClassPrairieInfil.cpp>");
...
{
InstrumentLogger::instance()->log_instrument_log("<ClassPrairieInfil::run(void)@@@ClassPrairieInfil.cpp>");
    long nstep;
...
{
InstrumentLogger::instance()->log_instrument_log("<ClassPrairieInfil::finish(bool good)@@@ClassPrairieInfil.cpp>");
    for (hh = 0; chkStruct (); ++ hh) {
