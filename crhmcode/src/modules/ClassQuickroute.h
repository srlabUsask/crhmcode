...
class ClassQuickroute : public ClassModule {
public:

ClassQuickroute(string Name, string Version = "undefined", LMODULE Lvl = LMODULE::PROTO) : ClassModule(Name, Version, Lvl) {};
...
ClassMuskingum *hruDelay_mkg{ NULL };
ClassClark *hruDelay_clark{ NULL };
...
ClassQuickroute* klone(string name) const;
};
