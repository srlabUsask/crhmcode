...
{
InstrumentLogger::instance()->log_instrument_log("<ClassCRHMCanopyClearingGap::klone(string name) const@@@ClassCRHMCanopyClearingGap.cpp>");
...
{
InstrumentLogger::instance()->log_instrument_log("<ClassCRHMCanopyClearingGap::decl(void)@@@ClassCRHMCanopyClearingGap.cpp>");
...
{
InstrumentLogger::instance()->log_instrument_log("<ClassCRHMCanopyClearingGap::init(void)@@@ClassCRHMCanopyClearingGap.cpp>");
...
{
InstrumentLogger::instance()->log_instrument_log("<ClassCRHMCanopyClearingGap::run(void)@@@ClassCRHMCanopyClearingGap.cpp>");
    ...
    for (hh = 0; chkStruct (); ++ hh) {
        ...
        case 0:
            Exposure = Ht [hh] - Common :: DepthofSnow (SWE [hh]);
            if (Exposure < 0.0)
            {
                Exposure = 0.0;
            }
        ...
        case 1:
            ...
            break;
        case 2:
            Exposure = Surrounding_Ht [hh] - Common :: DepthofSnow (SWE [hh]);
            if (Exposure < 0.0)
            {
                Exposure = 0.0;
            }
            ...
            Vf = 0.45 - 0.29 * log (LAI [hh]);
            double Tau_d = Vf + (1.0 - Vf) * sin ((Surrounding_Ht [hh] - Exposure) / Surrounding_Ht [hh] * M_PI_2);
        ...
        case 0:
            {
                if (Snow_load [hh] > 0.0 || hru_snow [hh] > 0.0)
                {
                    if (Sbar [hh] >= 0.0)
                    {
                        ...
                        double Vi = Vs * Ce;
                        Subl_Cpy [hh] = - Snow_load [hh] * Vi * Hs * Global :: Interval * 24 * 3600 / Hs;
        ...
        case 0:
            ...
            if (rain_load [hh] > 0.0)
            {
                ...
                {
                    Q = Qsi_ * 86400 / Global :: Freq / 1e6 / lambda (hru_t [hh]);
                    if (Qsi_ > 0.0)
                    {
...
{
InstrumentLogger::instance()->log_instrument_log("<ClassCRHMCanopyClearingGap::finish(bool good)@@@ClassCRHMCanopyClearingGap.cpp>");
    for (hh = 0; chkStruct (); ++ hh) {
...
double ClassCRHMCanopyClearingGap :: delta (double t)
{
InstrumentLogger::instance()->log_instrument_log("<ClassCRHMCanopyClearingGap::delta(double t)@@@ClassCRHMCanopyClearingGap.cpp>");
    if (t > 0.0)
    {
...
double ClassCRHMCanopyClearingGap :: lambda (double t)
{
InstrumentLogger::instance()->log_instrument_log("<ClassCRHMCanopyClearingGap::lambda(double t)@@@ClassCRHMCanopyClearingGap.cpp>");

InstrumentLogger::instance()->log_instrument_log("</ClassCRHMCanopyClearingGap::lambda(double t)@@@ClassCRHMCanopyClearingGap.cpp>");
    return (2.501 - 0.002361 * t);
InstrumentLogger::instance()->log_instrument_log("</ClassCRHMCanopyClearingGap::lambda(double t)@@@ClassCRHMCanopyClearingGap.cpp>");
}
double ClassCRHMCanopyClearingGap :: gamma (double Pa, double t)
{
InstrumentLogger::instance()->log_instrument_log("<ClassCRHMCanopyClearingGap::gamma(double Pa, double t)@@@ClassCRHMCanopyClearingGap.cpp>");

InstrumentLogger::instance()->log_instrument_log("</ClassCRHMCanopyClearingGap::gamma(double Pa, double t)@@@ClassCRHMCanopyClearingGap.cpp>");
    return (0.00163 * Pa / lambda (t));
InstrumentLogger::instance()->log_instrument_log("</ClassCRHMCanopyClearingGap::gamma(double Pa, double t)@@@ClassCRHMCanopyClearingGap.cpp>");
}
double ClassCRHMCanopyClearingGap :: RHOa (double t, double ea, double Pa)
{
InstrumentLogger::instance()->log_instrument_log("<ClassCRHMCanopyClearingGap::RHOa(double t, double ea, double Pa)@@@ClassCRHMCanopyClearingGap.cpp>");
    const double R = 2870;
