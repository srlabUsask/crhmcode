...
// CCustomPolarSeries wrapper class

class CCustomPolarSeries : public COleDispatchDriver
{
public:
	CCustomPolarSeries() {} // Calls COleDispatchDriver default constructor
	CCustomPolarSeries(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	CCustomPolarSeries(const CCustomPolarSeries& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
