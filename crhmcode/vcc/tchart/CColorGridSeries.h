...
public:
	...
	{
		double result;
		InvokeHelper(0xe9, DISPATCH_METHOD, VT_R8, (void*)&result, nullptr);
		return result;
	}
	double MaxYValue()
	{
		double result;
		InvokeHelper(0x14, DISPATCH_METHOD, VT_R8, (void*)&result, nullptr);
		return result;
	}
	double MinYValue()
	{
		double result;
		InvokeHelper(0x15, DISPATCH_METHOD, VT_R8, (void*)&result, nullptr);
		return result;
	}
	BOOL get_CenteredPoints()
	{
		BOOL result;
		InvokeHelper(0x1f5, DISPATCH_PROPERTYGET, VT_BOOL, (void*)&result, nullptr);
		return result;
	}
	void put_CenteredPoints(BOOL newValue)
	{
		static BYTE parms[] = VTS_BOOL;
		InvokeHelper(0x1f5, DISPATCH_PROPERTYPUT, VT_EMPTY, nullptr, parms, newValue);
	}
	void put_Bitmap(long newValue)
	{
		static BYTE parms[] = VTS_I4;
		InvokeHelper(0x1f7, DISPATCH_PROPERTYPUT, VT_EMPTY, nullptr, parms, newValue);
	}
	BOOL get_SmoothBitmap()
	{
		BOOL result;
		InvokeHelper(0x1f6, DISPATCH_PROPERTYGET, VT_BOOL, (void*)&result, nullptr);
		return result;
	}
	void put_SmoothBitmap(BOOL newValue)
	{
		static BYTE parms[] = VTS_BOOL;
	...
	long get_DrawPlane3D()
	{
		long result;
		InvokeHelper(0x1f9, DISPATCH_PROPERTYGET, VT_I4, (void*)&result, nullptr);
		return result;
	}
	void put_DrawPlane3D(long newValue)
	{
		static BYTE parms[] = VTS_I4;
		InvokeHelper(0x1f9, DISPATCH_PROPERTYPUT, VT_EMPTY, nullptr, parms, newValue);
	}
	long get_DrawPosition()
	{
		long result;
		InvokeHelper(0x1fa, DISPATCH_PROPERTYGET, VT_I4, (void*)&result, nullptr);
		return result;
	}
	void put_DrawPosition(long newValue)
	{
		static BYTE parms[] = VTS_I4;
	...
	{
		long result;
		InvokeHelper(0x1fc, DISPATCH_PROPERTYGET, VT_I4, (void*)&result, nullptr);
		return result;
	}
	void put_XGridEvery(long newValue)
	{
		static BYTE parms[] = VTS_I4;
