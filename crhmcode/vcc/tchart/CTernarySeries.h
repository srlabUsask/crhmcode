...
public:
	...
	long AddBubbleXYZ(double AX, double AY, double AZ, double ARadius, LPCTSTR ALabel, unsigned long AColor)
	{
		...
		InvokeHelper(0x19e, DISPATCH_METHOD, VT_I4, (void*)&result, parms, AX, AY, AZ, ARadius, ALabel, AColor);
		return result;
	}
	long AddBubbleXYZWeight(double AX, double AY, double AZ, double ARadius, double AWeight, LPCTSTR ALabel, unsigned long AColor)
	{
		...
		InvokeHelper(0x19f, DISPATCH_METHOD, VT_I4, (void*)&result, parms, AX, AY, AZ, ARadius, AWeight, ALabel, AColor);
		return result;
	}
	ITeePoint2D CalcPointFromValues(double a, double b, double C)
	{
		static BYTE parms[] = VTS_R8 VTS_R8 VTS_R8;
		InvokeHelper(0x1a0, DISPATCH_METHOD, VT_EMPTY, nullptr, parms, a, b, C);
	}

	// ITernarySeries properties
public:
