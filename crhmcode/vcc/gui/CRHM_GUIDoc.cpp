...
// CRHM_GUIDoc.cpp : implementation of the CCRHMGUIDoc class
//
...
IMPLEMENT_DYNCREATE(CCRHMGUIDoc, CDocument)

BEGIN_MESSAGE_MAP(CCRHMGUIDoc, CDocument)
END_MESSAGE_MAP()


// CCRHMGUIDoc construction/destruction
