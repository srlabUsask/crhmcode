...
public:
	...
	long AddBar(double AX, double AY, double AOffset, LPCTSTR ALabel, unsigned long AColor)
	{
		...
		InvokeHelper(0x1, DISPATCH_METHOD, VT_I4, (void*)&result, parms, AX, AY, AOffset, ALabel, AColor);
		return result;
	}
	LPDISPATCH get_OffsetValues()
	{
		LPDISPATCH result;
