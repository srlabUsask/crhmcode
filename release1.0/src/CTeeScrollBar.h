...
// CTeeScrollBar wrapper class

class CTeeScrollBar : public COleDispatchDriver
{
public:
	CTeeScrollBar() {} // Calls COleDispatchDriver default constructor
	CTeeScrollBar(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	CTeeScrollBar(const CTeeScrollBar& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
