...
// CCustomBoxSeries wrapper class

class CCustomBoxSeries : public COleDispatchDriver
{
public:
	CCustomBoxSeries() {} // Calls COleDispatchDriver default constructor
	CCustomBoxSeries(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	CCustomBoxSeries(const CCustomBoxSeries& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
