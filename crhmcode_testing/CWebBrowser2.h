...
class CWebBrowser2 : public COleDispatchDriver
{
public:
	CWebBrowser2() {}		// Calls COleDispatchDriver default constructor
	CWebBrowser2(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	CWebBrowser2(const CWebBrowser2& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
