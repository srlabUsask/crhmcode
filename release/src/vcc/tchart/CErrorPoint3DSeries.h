...
public:
	...
	{
		long result;
		static BYTE parms[] = VTS_R8 VTS_R8 VTS_R8 VTS_R8 VTS_R8 VTS_R8 VTS_R8 VTS_R8 VTS_R8 VTS_BSTR VTS_UI4;
		InvokeHelper(0x191, DISPATCH_METHOD, VT_I4, (void*)&result, parms, AX, AY, AZ, ALeft, ARight, ATop, ABottom, AFront, ABack, AXLabel, Value);
		return result;
	}
	...
	// IErrorPoint3DSeries properties
public:
