...
// CTeeShapePosition wrapper class

class CTeeShapePosition : public COleDispatchDriver
{
public:
	CTeeShapePosition() {} // Calls COleDispatchDriver default constructor
	CTeeShapePosition(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	CTeeShapePosition(const CTeeShapePosition& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
