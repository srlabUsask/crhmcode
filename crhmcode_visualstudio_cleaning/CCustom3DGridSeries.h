...
// CCustom3DGridSeries wrapper class

class CCustom3DGridSeries : public COleDispatchDriver
{
public:
	CCustom3DGridSeries() {} // Calls COleDispatchDriver default constructor
	CCustom3DGridSeries(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	CCustom3DGridSeries(const CCustom3DGridSeries& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
...
public:
	...
	// ICustom3DGridSeries properties
public:
